...
namespace XpressNetSharp
{
    ...
    /// </remarks>
    public class AddLocoToMultiUnitReqMessage : Message
    {
        /// <summary>
        /// Add a locomotive to a multi-unit consist, if it is not already contained in a consist currently maintained
        /// by the command station.
        ...
        public AddLocoToMultiUnitReqMessage(int address, ushort mtr) 
            : base(PacketHeaderType.LocomotiveFunction) 
        {
            Payload.Add(Convert.ToByte(PacketIdentifier.LocomotiveFunctionRequest.AddLocoToMultiUnit));
